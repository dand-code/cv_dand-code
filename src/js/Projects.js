...
function Projects() {
  return (
    <section id="projects">
      ...
      <ul className="list">
        <li>
          <h4>&#8260;&#8260; Searcher Ricky And Morty <a className="link" href="https://github.com/dand-code/search_ricky-morty">project</a> <a className="link" href="https://beta.adalab.es/modulo-3-evaluacion-final-dand-code/#/">web</a></h4>
        </li>
        <li>
